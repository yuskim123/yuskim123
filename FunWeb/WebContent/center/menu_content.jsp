...
<%
	...
	<td colspan="2"><input type="button" value="답      글쓰기" onclick="location.href='rewriteForm.jsp?num=<%=bb.getNum()%>&re_ref=<%=bb.getRe_ref()%>&re_lev=<%=bb.getRe_lev()%>&re_seq=<%=bb.getRe_seq()%>'"></td>
